...
const profileSchema = z.object({
  currentLevel: z.enum(['aaa-bantam', 'aaa-midget', 'junior-a', 'junior-b', 'ushl', 'nahl', 'bchl', 'high-school-varsity', 'prep-school', 'other']),
  position: z.enum(['left-wing', 'right-wing', 'center', 'left-defense', 'right-defense', 'goalie']),
  ...
  const onProfileSubmit = (data: ProfileData) => {
    startTransition(async () => {
      try {
        ...
        const result = await createStudentProfileAction(userId, profileData)
                ...
                {currentStep === 2 && (
                  <div className="space-y-6 text-center">
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-gray-500">
                        Once verified, you&apos;ll be automatically redirected to complete your hockey profile.
                      </p>
                    </div>
                ...
                {currentStep === 3 && (
                  <div className="space-y-6">
                    <div className="text-center mb-8">
                      ...
                      <p className="text-gray-600">Tell us about your hockey background and goals</p>
                    </div>
