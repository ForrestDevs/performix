...
export default function GetStartedPage() {
  ...
  const goalLevels = ["Division 1 (D1)", "Division 3 (D3)", "ACHA", "Junior Hockey", "Professional", "Not Sure Yet"]
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center text-white">
            <h1 className="text-4xl sm:text-5xl font-bold mb-4 font-['Space_Grotesk']">
              Start Your{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-200">D1 Journey</span>
            </h1>
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Join hundreds of players who&apos;ve transformed their hockey careers with elite mentorship
            </p>
                ...
                <div key={step.number} className="flex items-center">
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${
                      currentStep >= step.number ? "bg-white text-[#0891B2]" : "bg-white/20 text-white/60"
                    }`}
                  >
              ...
              <CardContent className="p-8">
                ...
                {currentStep === 2 && (
                  <div className="space-y-6">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Goal Level *</label>
                      <select
                  ...
                  <div className="space-y-6">
                    <div className="text-center mb-8">
                      <h2 className="text-2xl font-bold text-gray-900 mb-2">Mentor Pairing</h2>
                        <p className="text-gray-600">Let&apos;s get you matched with the perfect mentor</p>
                    </div>
                          ...
                          <div className="flex items-start space-x-3">
                            <div
                              className={`w-5 h-5 rounded-full border-2 mt-0.5 transition-all duration-200 ${
                                formData.needsCall ? "border-[#0891B2] bg-[#0891B2]" : "border-gray-300"
                              }`}
                            >
                              {formData.needsCall && <CheckCircle className="h-3 w-3 text-white m-0.5" />}
                            </div>
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-gray-600">
                                Schedule a 15-minute call to discuss your goals and get matched with the perfect mentor
                                based on your position, playing style, and aspirations.
                              </p>
                        ...
                        >
                          <div className="flex items-start space-x-3">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-gray-600">
                                Skip the pairing call and go directly to browsing mentors. You can always schedule a
                        ...
                        {formData.needsCall ? (
                          <>
                            ...
                            <div className="flex items-center space-x-3">
                              ...
                              <span>Discuss your goals and get personalized mentor recommendations</span>
                            </div>
                            <div className="flex items-center space-x-3">
                              <div className="w-6 h-6 bg-[#0891B2] rounded-full flex items-center justify-center text-white text-xs font-bold">
                                3
          ...
          >
            <div className="grid md:grid-cols-3 gap-8 text-center">
              ...
              <div className="space-y-3">
                ...
                <p className="text-gray-600 text-sm">All mentors are background-checked D1+ players</p>
              </div>
              <div className="space-y-3">
                <div className="w-16 h-16 bg-[#0891B2]/10 rounded-full flex items-center justify-center mx-auto">
                ...
                <p className="text-gray-600 text-sm">94% of our athletes receive D1 offers within 12 months</p>
              </div>
            </div>
          </div>
        </div>
