...
import { PLANS_SLUG } from '@/payload/collections/constants'
import CurrentPlan from '@/components/layout/students/current-plan'
...
export default async function ConsumerDashboard() {
  ...
  const enrolledBlueprints = await getEnrolledBlueprints(Number(user.id))
  ...
  const enrolledPlan = await getEnrolledPlan(Number(user.id))
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            <CurrentPlan enrolledPlan={enrolledPlan} />
            <EnrolledBlueprints blueprints={enrolledBlueprints || []} />
