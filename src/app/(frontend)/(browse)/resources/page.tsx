  ...
  const articles = [
    {
      ...
      excerpt: "Discover the psychological techniques used by D1 athletes to perform under pressure.",
      author: {
        name: "Sarah Chen",
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Insights, tips, and stories from D1+ mentors and athletes to accelerate your hockey development
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div
            ...
            className={`transition-all duration-1000 ${
              isVisible("featured-article") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
            }`}
          >
                ...
                <div className="grid lg:grid-cols-2 gap-0">
                  <div className="relative h-96 lg:h-auto group overflow-hidden">
                    ...
                    <div className="absolute bottom-6 left-6 text-white">
                      ...
                      <h2 className="text-2xl lg:text-3xl font-bold mb-2 leading-tight">{featuredArticle.title}</h2>
                  ...
                  <div className="p-8 lg:p-12 flex flex-col justify-center">
                    ...
                    <div className="flex space-x-4">
                      ...
                      >
                        <Heart className={`h-4 w-4 ${favoriteIds.has(featuredArticle.id) ? "fill-current" : ""}`} />
                      </Button>
                      <Button
                        variant="outline"
                        size="sm"
                    ...
                    {articles.map((article, index) => (
                      <Card
                        ...
                        className={`border-0 shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-1 group cursor-pointer ${
                          isVisible("articles-grid") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                        }`}
                          ...
                          <div className="relative h-48 overflow-hidden">
                            ...
                            <div className="absolute top-4 left-4">
                              ...
                              >
                                ...
                                {article.type === "article" && <BookOpen className="h-3 w-3 mr-1" />}
                              ...
                              >
                                <Heart
                                  className={`h-4 w-4 transition-colors duration-200 ${
                                    favoriteIds.has(article.id) ? "text-red-500 fill-current" : "text-gray-600"
                                  }`}
                                />
                              </Button>
                            </div>
                            {article.type === "video" && (
                              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/20">
                                <Button size="lg" className="bg-white/90 text-red-500 rounded-full w-12 h-12 p-0">
                    ...
                    {articles.map((article, index) => (
                      <Card
                        ...
                        className={`border-0 shadow-lg hover:shadow-xl transition-all duration-500 group cursor-pointer ${
                          isVisible("articles-grid") ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"
                        }`}
                        style={{ transitionDelay: `${index * 100}ms` }}
                      >
                                ...
                                >
                                  <Heart
                                    className={`h-5 w-5 transition-colors duration-200 ${
                                      favoriteIds.has(article.id) ? "text-red-500 fill-current" : "text-gray-400"
                                    }`}
                                  />
                                </Button>
                              </div>
            ...
            <div className="lg:col-span-1 space-y-8">
              ...
              <Card
                ...
                className={`border-0 shadow-lg transition-all duration-1000 ${
                  isVisible("trending-sidebar") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
              >
                <CardContent className="p-6">
              ...
              <Card
                ...
                data-scroll-animate
                className={`border-0 shadow-lg transition-all duration-1000 ${
                  isVisible("author-spotlight") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
              >
                <CardContent className="p-6">
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex justify-center space-x-6 mb-4 text-sm">
                      ...
                      <div className="text-center">
                        <p className="font-bold text-[#0891B2]">{authorSpotlight.followers.toLocaleString()}</p>
                        <p className="text-gray-500 text-xs">Followers</p>
                      </div>
                    </div>
                    <Button size="sm" className="bg-[#0891B2] hover:bg-[#0E7490] text-white w-full mb-4">
              ...
              <Card
                ...
                className={`border-0 shadow-lg bg-gradient-to-br from-[#0891B2] to-[#8B5CF6] text-white transition-all duration-1000 ${
                  isVisible("newsletter-signup") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
              >
                <CardContent className="p-6 text-center">
                  ...
                  <div className="space-y-3">
                    ...
                    />
                    <Button className="bg-white text-[#0891B2] hover:bg-gray-100 w-full">Subscribe</Button>
                  </div>
                  <p className="text-white/70 text-xs mt-3">Join 2,500+ hockey players and parents</p>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#0891B2] to-[#0E7490]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">Ready to Take Your Game to the Next Level?</h2>
