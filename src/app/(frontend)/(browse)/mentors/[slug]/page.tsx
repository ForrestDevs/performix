...
const mentorData = {
  ...
  shortBio: "3x All-American forward with extensive recruiting experience. Helped 50+ players secure D1 commitments.",
  ...
  skills: [
    { name: "Offensive Strategy", level: 95, description: "Elite offensive zone tactics and scoring techniques" },
    { name: "Recruiting Guidance", level: 98, description: "Expert knowledge of D1 recruiting process" },
    { name: "Skating Technique", level: 90, description: "Advanced edge work and power skating" },
    { name: "Shot Development", level: 92, description: "Precision shooting and release techniques" },
...
export default function MentorProfilePage() {
  ...
  const filteredGalleryItems =
    galleryFilter === "All" ? mentorData.gallery : mentorData.gallery.filter((item) => item.category === galleryFilter)

  // Get unique gallery categories
  const galleryCategories = ["All", ...Array.from(new Set(mentorData.gallery.map((item) => item.category)))]
          ...
          >
            ...
            <div className="flex flex-wrap gap-6 mb-8">
              ...
              <div className="flex items-center space-x-2 text-white/90">
                ...
                <span>
                  {mentorData.reviews.reduce((acc, review) => acc + review.rating, 0) / mentorData.reviews.length} (
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            <section ref={sectionRefs.about} id="about-section" className="scroll-mt-32">
              ...
              >
                <h2 className="text-3xl font-bold text-gray-900 mb-6 font-['Space_Grotesk']">About Jake</h2>
                  ...
                  <Card>
                    <CardContent className="p-6">
                      ...
                      <div className="relative h-8 bg-gray-100 rounded-full mb-4">
                        {Array.from({ length: mentorData.agesServed.max - mentorData.agesServed.min + 1 }).map(
                          (_, i) => {
                  ...
                  <Card>
                    <CardContent className="p-6">
                      ...
                      <p className="mt-4 text-sm text-gray-600">
                        Primary focus on hockey with additional experience in other sports for cross-training benefits.
                      </p>
                    </CardContent>
                  </Card>
                </div>
            ...
            <section ref={sectionRefs.experience} id="experience-section" className="scroll-mt-32">
              <div
                ...
                data-scroll-animate
                className={`mb-8 transition-all duration-1000 ${
                  isVisible("experience-header") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
              >
                <h2 className="text-3xl font-bold text-gray-900 mb-6 font-['Space_Grotesk']">Experience & Career</h2>
              </div>
                  ...
                  {mentorData.experience.map((exp, index) => (
                    <div
                      ...
                      className={`relative pl-12 transition-all duration-1000 ${
                        isVisible(`experience-${index}`) ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                      }`}
            ...
            <section ref={sectionRefs.gallery} id="gallery-section" className="scroll-mt-32">
              <div
                ...
                data-scroll-animate
                className={`mb-8 transition-all duration-1000 ${
                  isVisible("gallery-header") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
              >
                <h2 className="text-3xl font-bold text-gray-900 mb-6 font-['Space_Grotesk']">Media Gallery</h2>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {filteredGalleryItems.map((item, index) => (
                  <motion.div
                    ...
                    animate={isVisible(`gallery-item-${index}`) ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.9 }}
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="bg-black/70 p-4 text-white">
                        <p className="font-medium text-lg">{mentorData.gallery[activeGalleryItem]?.caption}</p>
                        <p className="text-sm text-gray-300 mt-1">{mentorData.gallery[activeGalleryItem]?.category}</p>
                      </div>
                    </motion.div>
                  </motion.div>
                )}
            ...
            <section ref={sectionRefs.reviews} id="reviews-section" className="scroll-mt-32">
              <div
                ...
                data-scroll-animate
                className={`mb-8 transition-all duration-1000 ${
                  isVisible("reviews-header") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
              >
              ...
              <div className="space-y-6">
                {mentorData.reviews.map((review, index) => (
                  <div
                    ...
                    data-scroll-animate
                    className={`transition-all duration-1000 ${
                      isVisible(`review-${index}`) ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                    }`}
                    style={{ transitionDelay: `${index * 200}ms` }}
                  >
                    <Card className="border-0 shadow-md hover:shadow-lg transition-shadow duration-300">
                            ...
                            <div className="mt-4 flex flex-wrap items-center gap-4">
                              ...
                              <div className="flex items-center space-x-2">
                                <div className="flex flex-col items-center">
                                  ...
                                  <span className="text-sm font-medium">{review.progress.before}</span>
                                </div>
                                <ArrowRight className="h-4 w-4 text-[#0891B2]" />
                                <div className="flex flex-col items-center">
                                  <span className="text-xs text-gray-500">After</span>
                                  <span className="text-sm font-medium text-[#0891B2]">{review.progress.after}</span>
                                </div>
                              </div>
                            </div>
                          </div>
            ...
            <section ref={sectionRefs.availability} id="availability-section" className="scroll-mt-32">
              <div
                id="availability-header"
                data-scroll-animate
                className={`mb-8 transition-all duration-1000 ${
                  isVisible("availability-header") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
              >
                <h2 className="text-3xl font-bold text-gray-900 mb-6 font-['Space_Grotesk']">Availability & Booking</h2>
              </div>
                    ...
                    <div>
                      ...
                      <div className="mt-8">
                        <Button
                          ...
                          onClick={() => setIsBookingOpen(true)}
                        >
                          {!selectedDate || !selectedTime ? "Select Date & Time" : "Book This Session"}
                          <Calendar className="ml-2 h-5 w-5" />
                        </Button>
                      </div>
                    </div>
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                        Not ready to book yet? Send a message and I&apos;ll get back to you within 24 hours.
                  </p>
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-white/90 text-lg mb-8">
              Join the 50+ players who have secured D1 commitments with Jake&apos;s mentorship. Book your session today and
              start your journey to hockey excellence.
            </p>
            ...
            >
              <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-2xl font-bold text-gray-900">Book a Session with {mentorData.name}</h2>
                  <button
                    onClick={() => setIsBookingOpen(false)}
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <Badge className="bg-[#0891B2] text-white">${selectedSessionType?.price}</Badge>
                      </div>
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <div className="flex justify-between items-center mb-4">
                        ...
                        <span className="text-xl font-bold text-[#0891B2]">${selectedSessionType?.price || 0}</span>
                      </div>
                      <p className="text-sm text-gray-600 mb-4">
                        Secure payment processing. You will not be charged until your session is confirmed.
                      </p>
                      <div className="flex items-center space-x-2 mb-4">
