    ...
    <div>
      ...
      <section className="py-24 px-4 bg-card/30 flex flex-col items-center justify-center">
        ...
        <Link
          ...
          className={cn(
            buttonVariants({ size: 'lg' }),
            'bg-[#0891B2] hover:bg-[#0E7490] text-white whitespace-normal text-center leading-tight px-8 py-4 text-lg hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl mx-auto',
          )}
        >
          Apply for Free 1-on-1 Session
