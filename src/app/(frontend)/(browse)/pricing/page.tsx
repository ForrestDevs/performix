    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center justify-center space-x-4 mb-8">
              <button
                ...
                className={`px-4 py-2 rounded-lg transition-all duration-300 ${
                  billingCycle === "monthly" ? "bg-white text-[#0891B2] font-medium" : "text-white/80 hover:text-white"
                }`}
              >
                Monthly
              </button>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg transition-all duration-300 ${
                  billingCycle === "annual" ? "bg-white text-[#0891B2] font-medium" : "text-white/80 hover:text-white"
                }`}
              >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                >
                  ...
                  <CardFooter className="pt-4 pb-8">
                    <Button
                      className={`w-full ${
                        plan.recommended ? "bg-[#0891B2] hover:bg-[#0E7490]" : "bg-blue-500 hover:bg-blue-600"
                      } text-white`}
                    >
                      Get started
          ...
          >
            ...
            <p className="mt-2 text-gray-600 max-w-2xl mx-auto">
              Try any plan risk-free. If you&apos;re not completely satisfied within 30 days, we&apos;ll refund your payment.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div
            ...
            className={`text-center mb-12 transition-all duration-1000 ${
              isVisible("comparison-header") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-4 font-['Space_Grotesk']">Compare Mentorship Plans</h2>
          ...
          <div
            ...
            data-scroll-animate
            className={`transition-all duration-1000 ${
              isVisible("comparison-table") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-gray-200 hover:bg-gray-50">
                    <td className="py-4 px-6 text-gray-800 font-medium">Weekly Performance Check-Ins</td>
                    {plans.map((plan) => (
                  ...
                  {/* Private Community Access */}
                  <tr className="border-b border-gray-200 hover:bg-gray-50">
                    <td className="py-4 px-6 text-gray-800 font-medium">Private Community Access</td>
                    {plans.map((plan) => (
                  ...
                  <tr className="border-b border-gray-200 hover:bg-gray-50">
                    <td className="py-4 px-6 text-gray-800 font-medium">Off-Season Training Program</td>
                    {plans.map((plan) => (
                      <td key={`${plan.id}-offseason`} className="py-4 px-6 text-center">
                        {plan.bonusFeatures?.some((f) => f.includes("Off-Season Training Program")) ? (
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Hear from players who&apos;ve transformed their hockey careers with our mentorship programs
            </p>
          </div>
                  ...
                  <CardContent className="p-8">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Committed to {testimonial.commitment}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-4 font-['Space_Grotesk']">Frequently Asked Questions</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">Everything you need to know about our mentorship programs</p>
          </div>
              ...
              {faqs.map((faq, index) => (
                <div
                  ...
                  className={`border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-all duration-700 ${
                    isVisible(`faq-${index}`) ? "opacity-100 translate-x-0" : "opacity-0 translate-x-4"
                  }`}
      ...
      <section className="py-20 bg-gradient-to-r from-[#0891B2] to-[#0E7490]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-6 text-sm opacity-75">No credit card required to start • 30-day money-back guarantee</p>
          </div>
        </div>
      </section>
    </div>
