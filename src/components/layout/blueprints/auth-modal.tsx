...
export default function AuthModal({ isOpen, onClose, blueprintTitle }: AuthModalProps) {
  return (
        ...
        >
          <DialogHeader className="text-center pb-6">
            ...
            <p className="text-gray-600 mt-2">
              Sign in to access the full blueprint and download all resources
            </p>
          </DialogHeader>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-4 border border-blue-100">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-center gap-2">
                  ...
                  Full blueprint content and instructions
                </li>
                <li className="flex items-center gap-2">
                  <ArrowRight className="h-3 w-3 text-[#0891B2]" />
