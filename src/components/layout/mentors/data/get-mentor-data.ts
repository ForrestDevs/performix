import { type MentorData } from '../profile/mentor-context'

// This would typically fetch from your API/database
// For now, returning the sample data that was in the original component
export async function getMentorData(slug: string): Promise<MentorData | null> {
  // Simulate async data fetching
  await new Promise((resolve) => setTimeout(resolve, 100))

  // Sample mentor data - in a real app, this would come from your database/API
    ...
    experience: [
      {
        ...
        endDate: 'Present',
        description:
          'Developing elite AAA players and helping them navigate the recruiting process',
  ...
  // Return the mentor if the slug matches, otherwise null
  return mentorData.id === slug ? mentorData : null
}
