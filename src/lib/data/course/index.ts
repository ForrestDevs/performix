...
//   const completedEnrollments = enrollments.docs.filter((e) => e.status === 'refunded').length
...
//   const enrolledCourse = enrollment.enrolledCourse as Course
...
//   // const allCompleted = allLessons.every((lesson) => lesson.status === 'completed')
...
//     id: enrollmentId,
//     data: {
//       status: allCompleted ? 'refunded' : 'active',
//     },
//   })
